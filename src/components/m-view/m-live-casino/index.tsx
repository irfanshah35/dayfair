...
const MLiveCasino = () => {
  ...
  return (
    ...
    >
      <div className="relative shadow-[0_8px_8px_-7px_rgb(33,37,41)] flex items-center md:mt-[3px] justify-between bg-linear-to-b from-[#030a12] via-[#444647] to-[#58595a] overflow-hidden lg:mb-3 h-[33px]">
        {/* Menu Items */}
            ...
            <li key={index}>
              <a href="#" className="block">
                <div
                  ...
                  className={`text-center px-[15] whitespace-nowrap h-[33px] py-1 tracking-[-0.10px] border-r border-white transition cursor-pointer ${
                    activeIndex === item?.menuId
