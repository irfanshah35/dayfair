...
export default function BetHistory() {
    ...
    <div className="md:m-[5px] ">
      <div className="relative flex flex-col min-w-0 wrap-break-word bg-white md:border border-black/12.5 rounded">
        ...
        <div className="px-4 py-1 md:py-0 rounded-xs bg-black/3 border-b btn-clr border-black/12.5">
          <h4 className="mb-0 text-base md:text-[24px] ">Bet History</h4>
        </div>
  ...
  <div className="w-full flex gap-2 px-[5px] mb-2 md:w-1/3 md:gap-0 md:mb-0">
    {/* Exchange Dropdown */}
    <div className="flex-1 md:w-1/2 md:pr-[5px]">
      <select
    ...
    {/* UNMATCHED Dropdown */}
    <div className="flex-1 md:w-1/2 md:pl-[5px]">
      <select
        className="w-full h-[38px] px-3 py-1.5 text-base text-[#555] bg-white border border-[#ced4da] rounded appearance-none cursor-pointer"
        style={{
          backgroundImage: `url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3E%3Cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E")`,
  ...
  {/* Submit Button */}
  <div className="w-full md:w-1/12 px-[5px]">
    <button
          ...
          <div className="flex flex-wrap -mx-[5px] mt-3">
            <div className="w-full px-[5px] overflow-x-auto">
              <table className="w-full border-collapse border border-black/12.5">
                <thead>
                  <tr>
                    <th className="px-2 py-1 md:px-3 md:py-2 text-left  text-black bg-[#e9ecef] border border-black/12.5 text-sm md:text-base">
                      Description
                    </th>
                    <th className="px-2 py-1 md:px-3 md:py-2 text-left  text-black bg-[#e9ecef] border border-black/12.5 text-sm md:text-base">
                      Bid Type
                    ...
                    <th className="px-2 py-1 md:px-3 md:py-2 text-left text-black bg-[#e9ecef] border border-black/12.5 font-bold text-sm md:text-base">
                      Stake
                    </th>
                    <th className="px-2 py-1 md:px-3 md:py-2 text-left text-black bg-[#e9ecef] border border-black/12.5 text-sm md:text-base">
                      Avg Odds
